...
open(unit=45, file='totalenlow.dat', access='direct', form='unformatted', status='unknown', action='write', recl=4*(Nx-2)*(Ny-2))
irec=0
do n=1,3
        irec=irec+1
...
open(unit=10, file='hightopolow.dat', access='direct', form='unformatted', status='unknown', action='write', recl=4*(Nx-2)*(Ny-2))  !scary thing
write(10, rec=1) hsurf(2:Nx-1,2:Ny-1)

open(unit=15, file='highgeopotlow.dat', access='direct', form='unformatted', status='unknown', action='write', recl=4*(Nx-2)*(Ny-2))
irec=0
do n=1,3
        irec=irec+1
...
open(unit=20, file='uwindlow.dat', access='direct', form='unformatted', status='unknown', action='write', recl=4*(Nx-2)*(Ny-2))
irec=0
do n=1,3
        irec=irec+1
...
open(unit=25, file='vwindlow.dat', access='direct', form='unformatted', status='unknown', action='write', recl=4*(Nx-2)*(Ny-2))
irec=0
do n=1,3
        irec=irec+1
